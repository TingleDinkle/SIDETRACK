...
// Case 4: A working level where the train goes through a switch, but that switch has no matching junction anywhere
const level = {
  "id": "switch-no-effect",
  "world": 1,
...
console.log(`\nGrid has ${switches.length} switches with color 'blue'`);
...
console.log("\n✓ The loco successfully passed through the switch WITHOUT any effect (no events, no error)");
