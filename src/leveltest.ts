...
import { addEdge, Heading } from './types.js';
...
type Seg = { x: number; y: number; edges: Heading[] };

/** A verified track layout (player-placed cells) for each level id. */
const SOLUTIONS: Record<string, Seg[]> = {
  '1-1': [
    { x: 1, y: 1, edges: ['E', 'W'] },
    { x: 2, y: 1, edges: ['E', 'W'] },
    { x: 3, y: 1, edges: ['E', 'W'] },
  ...
  '2-3': [
    { x: 1, y: 0, edges: ['E', 'W'] }, // into the top tunnel heading east
    { x: 1, y: 4, edges: ['E', 'W'] }, // out of the bottom tunnel heading west, to the goal
  ],
  '3-1': [
    { x: 1, y: 1, edges: ['E', 'W'] },
    { x: 3, y: 1, edges: ['E', 'W'] },
